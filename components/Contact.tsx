  ...
  return (
    <section id="contact" className="pt-20 pb-8 px-8 lg:px-16 bg-charcoal text-cream">
      <div className="max-w-6xl mx-auto text-center">
        ...
        {/* Location + Map — Two-column on desktop */}
        <div className="pt-10 border-t border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center text-left md:text-left">
            ...
            <div className="text-center md:text-left">
              ...
              <a
                href="tel:+17026132115"
                className="text-cream/70 text-sm hover:text-cream transition-colors duration-200 block mt-1"
              >
                (702) 613-2115
              </a>
