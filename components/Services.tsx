const services = {
  ...
  pedicures: [
    ...
    {
      name: "CBD Wellness Pedicure",
      description: "Organic CBD-infused soak, anti-inflammatory relief, deep relaxation",
      regular: "$75",
      gel: "$95",
    },
    {
      name: "Elorae Signature Pedicure",
      description: "Our most indulgent — salt soak, organic oils, hot stones, paraffin",
      regular: "$110",
      gel: "$130",
    },
    {
      name: "Elorae CBD Retreat",
      description: "Ultimate therapeutic experience with CBD treatment throughout",
      regular: "$125",
      gel: "$145",
    },
  ],
  ...
  extras: [
    ...
    { name: "Almond / Coffin / Ballerina", price: "+$10" },
